...
dataset_list = ['physionet','physionet2017','cardiology','ptb','fetal','physionet2016','physionet2020','chapman','uci_emg','ptbxl']#,'cipa']
batch_size_list = [256, 256, 16, 64, 64, 256, 256, 256, 256, 256]#, 512]
lr_list = [1e-4, 1e-4, 1e-4, 5e-5, 1e-4, 1e-4, 1e-4, 1e-4, 1e-5, 5e-4]#, 1e-4]
...
def obtain_dataset_order(trial,cl_scenario,dataset_name,fraction,order):
    ...
    if cl_scenario == 'Domain-IL':
        ...
        ntasks = 3
        new_task_datasets = ['chapman','physionet2020','ptbxl'] #['chapman','cardiology']	#,'cardiology','physionet2017']#cardiology']
        new_task_modalities = [['ecg']] * ntasks
        new_task_leads = ["['II', 'V2', 'aVL', 'aVR']","['II', 'V2', 'aVL', 'aVR']","['II', 'V2', 'aVL', 'aVR']"] #"['all']",'i']	#"['II', 'aVR']"] 
        new_task_class_pairs = ['All Terms','',''] 	#['Term 1','']	#[''] * ntasks
        new_task_fractions = [1,1,1]	#[1, 0.9]	#[fraction] * ntasks
    ...
    elif cl_scenario == 'Device-IL':
        task_epochs = 30
        ntasks = 2
        new_task_datasets = ['ptbxl'] * ntasks
        new_task_modalities = [['ecg']] * ntasks
        new_task_leads = ["['II', 'V2', 'aVL', 'aVR']"] * ntasks #["['I','II','III','aVR','aVL','aVF','V1','V2','V3','V4','V5','V6']"] * ntasks
        new_task_class_pairs = ['AT','CS']
        new_task_fractions = [1] * ntasks
