...
import copy
import torch
from prepare_acquisition_functions import perform_MC_sampling, acquisition_function, update_acquisition_dict
...
#                print(models_list)
        ...
        for relevant_dataset,phase,inference in zip(relevant_datasets,phases,inferences):            
            if heads == 'single':
                ...
                if relevant_dataset == 'physionet2020' or relevant_dataset == 'ptbxl' or cl_scenario == 'Class-IL': #multilabel binary classification setting
